...
Then a two or three sentence setup: what most people get wrong and a promise to reframe it.

The body breaks into sections: **name the point, show how to use it and explain why it matters.**

Mark pattern interrupts in italics every 30 to 45 seconds ordered important, **most important** then third.

Close with one call to action tied to a problem from the body then a short sign-off.
...
*Cut to a showing 50 videos × 12 languages.*
...
**The call to action is:** *"If you want to do the same without a hassle you can just use our [free AI video translator](https://www.synthesia.io/features/video-translator) and localise your videos in hundreds of languages."*
...
## But how do you write a script for a YouTube Shorts?
...
If your hook is ten seconds long your intro shouldn’t  be more than 30\. Two or three sentences are enough.
...
Long sentences are hard to follow. Break them up into two or more sentences if they take more than five seconds to say.
...
The word count of your script is important. Aim for 120 to 150 words per minute.
